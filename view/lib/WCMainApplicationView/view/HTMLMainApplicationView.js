...
// import { GroupView } from "../../WCGroupView/components/groupView.js";

class HTMLMainApplicationView extends HTMLElement {
...
/*     openUserPage(){
        window.open('../../WCUserView/application.html');
    }
 */
}


customElements.define('x-main-application-view', HTMLMainApplicationView);

export {HTMLMainApplicationView}