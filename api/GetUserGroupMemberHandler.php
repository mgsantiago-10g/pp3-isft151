...
class GetUserFromGroupErrorType
{
...
try
{
    ...
    {
        throw new Exception("Invalid data type",GetUserFromGroupErrorType::ERR_INVALID_DATA);
    }

    //Execute API Class Method/Procedure
    $groupMemberHandler = new GroupMemberHandler();
    $response= $groupMemberHandler->getUser($group_id, $user_id);
    ...
    throw new Exception("Error Invalid data type", GetUserFromGroupErrorType::ERR_INVALID_DATA);
