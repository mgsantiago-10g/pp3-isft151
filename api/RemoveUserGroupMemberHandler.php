...
class RemoveUserFromGroupErrorType
{
...
try
{
    ...
    {
        throw new Exception("Invalid data type",RemoveUserFromGroupErrorType::ERR_INVALID_DATA);
    }
    
    //Execute API Class Method/Procedure
    $groupMemberHandler = new GroupMemberHandler();
    $groupMemberHandler->removeUser($group_id, $user_id);
    ...
    throw new Exception("Error Invalid data type", RemoveUserFromGroupErrorType::ERR_INVALID_DATA);
