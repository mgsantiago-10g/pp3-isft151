...
class GetGroupHandlerErrorType
{
...
try
{
    ...
    {
        throw new Exception("Invalid data type", GetGroupHandlerErrorType::ERR_INVALID_DATA);
    }
    
    //Execute API Class Method/Procedure
    $groupHandler = new GroupHandler();
    $response= $groupHandler->get($group_id);
    ...
    throw new Exception("Error Invalid data type", GetGroupHandlerErrorType::ERR_INVALID_DATA);
